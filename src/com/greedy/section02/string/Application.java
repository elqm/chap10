...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * 인덱스를 벗어난 정수를 인자로 전달하는 경우에는 StringIndexOutOfBoundsException이 발생한다.
		 * */
		String str1 = "apple";
		...
		/* compareTo() : 인자로 전달된 문자열 사전 순으로 비교를 하여
...
//		System.out.println(badFileName.replace("../", ""));
		
		/* subString() : 문자열의 일부를 잘라내서 새로운 문자열을 반환한다.
		 * 원본에 영향을 주지 않는다.
		 * */
